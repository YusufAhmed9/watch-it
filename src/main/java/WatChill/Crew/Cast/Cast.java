...
public class Cast extends Crew {
    ...
    public Cast(String firstName, String lastName, LocalDate dateOfBirth, String gender, String nationality, String instagramLink, String twitterLink, String picture) {
