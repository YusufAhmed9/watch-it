...
abstract public class User {
    ...
    public static boolean createUser(String username, String email, String password, String firstName, String lastName) {
        ...
        if (getUsers().isEmpty()) {
            ...
            user = new Customer(UUID.randomUUID().toString(), username, email, password, firstName, lastName, new ArrayList<>());
        }
        user.saveUser();
        setCurrentUser(user);
        return true;
    ...
    public void delete() {
        ...
        if (getId().equals(currentUser.getId())) {
            setCurrentUser(null);
        }
    }
